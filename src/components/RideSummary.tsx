...
const RideSummary = ({ pickup, destination, date, time, passengers, vehicle }: RideSummaryProps) => {
  ...
  return (
    <div className="animate-fade-in">
      <h3 className="text-lg font-medium text-neutral-900 mb-4">Ride Summary</h3>
      ...
      <div className="bg-neutral-50 rounded-xl p-5 mb-6">
        <div className="flex items-start mb-4">
          ...
          <div className="flex-1">
            <div className="mb-3">
              <p className="text-sm text-neutral-500">Pickup Location</p>
      ...
      <div className="bg-neutral-50 rounded-xl p-5 mb-6">
        ...
        <div className="border-t border-neutral-200 pt-4">
          ...
          <div className="flex justify-between mb-2">
            <span className="text-neutral-600">Distance ({estimatedDistance} miles)</span>
          ...
          <div className="flex justify-between text-lg font-semibold border-t border-neutral-300 pt-3">
            <span>Total</span>
